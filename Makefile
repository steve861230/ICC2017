...
rtlsim:
	ncverilog $(testfixture) $(rtl_design) +access+r +notimingcheck +define+TB1 +define+FSDB

## edit your gate-level simulation command
glsim:
	ncverilog $(testfixture) $(netlist) -v $(tsmc13) $(tsmc13_neg) +access+r +define+SDF +define+TB1 +define+FSDB
